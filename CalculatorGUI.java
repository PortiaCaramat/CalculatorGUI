...
public class CalculatorGUI extends JFrame {
    ...
    public CalculatorGUI() {
        setTitle("Calculator");
        setSize(400, 250);  // 📌changed width to 400 for automatic wider display
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                switch (operator) {
                    ...
                    case "/":
                        if (num2 == 0) {
                            JOptionPane.showMessageDialog(null, "Cannot divide by zero!", "Reminder", JOptionPane.WARNING_MESSAGE);
                            return; // 📌added title and changed message type
                        }
                        result = num1 / num2;
                        break;
                    default:
